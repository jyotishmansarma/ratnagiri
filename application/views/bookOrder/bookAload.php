                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="<?=base_url('BookAload/bookLoad');?>" method="post" class="was-validated"onSubmit="return checkform()">
                                        <div class="row">
                                             <!--sl no-->
                                            <div class="col-3">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                        <input id="consignor_name" name="consignor_name" type="text" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="cosignee_name" type="text" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off"required>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <textarea id="x_card_code" name="consignor_adress" class="form-control cc-cvc" value="" data-val="true"   rows="5" id="comment" data-val-cc-cvc="Please enter a valid security code" autocomplete="off"required></textarea>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                            <textarea id="x_card_code" name="cosignee_adress" class="form-control cc-cvc" value="" data-val="true"   rows="5" id="comment" data-val-cc-cvc="Please enter a valid security code" autocomplete="off"required></textarea>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="consignor_gst_no" type="tel" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="cosignee_gst_no" type="text" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                 ...
                                 <div class="row">
                                      <!--number of goods-->
                                       <div class="col-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="number_of_goods" name="number_of_goods" type="number" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder=""
                                     ...
                                     <div class="col-3">
                                       ...
                                       <div class="form-group ">
                                                ...
                                                <input id="amount" name="amount" type="number" class="form-control cc-exp" data-val="true" data-val-required="Please enter the name on card"
                                     ...
                                     <div class="col-3">
                                        <div class="form-group ">
                                                ...
                                                <input id="paid" name="paid" type="number" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error"required>
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                        </div>
                                     </div>
                                     ...
                                     <div class="col-3">
                                        <div class="form-group ">
                                                ...
                                                <input id="to_pay" name="to_pay" type="number" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
