                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <?php echo form_error('branch_name') ?>  <?php echo form_error('branch_code') ?>
                                        <form action="<?=base_url('Branch/createBranch');?>" method="post" class="was-validated">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">BRANCH NAME</label> 
                                                   
                                                    <div class="input-group">
                                                        <input id="branch_name" name="branch_name" type="text" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="branch_status" id="branch_status" class="form-control-lg form-control" style="padding:4px;" required>
