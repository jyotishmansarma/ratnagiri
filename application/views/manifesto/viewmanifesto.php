            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                 <div class="container-fluid">
                    <form action="<?=base_url('MainFesto/viewManifestoData');?>" method="get" class="form-horizontal">
                        <div class="row form-group">
                            ...
                            <div class="col col-md-3">
                                ...
                                <select name="booking_to" id="booking_to" class="form-control-lg form-control" style="padding:3px;">
                                                       <option value="0"></option>
                                                       <?php foreach ($data1 as $value): ?>
                                                       <option value="<?php echo $value->branch_name; ?>"><?php echo $value->branch_name; ?></option>
