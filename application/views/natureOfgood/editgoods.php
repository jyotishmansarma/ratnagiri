                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <form action="<?=base_url("/NatureOfgoods/updategoods/{$goodsName->goods_id}")?>" method="post" class="was-validated">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">NATURE OF GOODS</label> 
                                                   
                                                    <div class="input-group">
                                                    <?php echo form_input(['class'=>'form-control cc-cvc','id'=>'x_card_code', 'name'=>'nature_of_goods','type'=>'tel','value'=>set_value('nature_of_goods',$goodsName->nature_of_goods),'data-val'=>'true','data-val-required'=>'Please enter the security code', 'data-val-cc-cvc'=>'Please enter a valid security code', 'autocomplete'=>'off','required'=>'true']);  ?>
